...
public class Linear_Search {
    ...
    public static void main(String[] args) {
        ...
        int atIndex = Linear_Search.unorderedLinearSearch(shouldBeFound, integers);
        ...
        atIndex = Linear_Search.orderedLinearSearch(key, sortedArray);
